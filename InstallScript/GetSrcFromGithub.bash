...
# This gets a tarball from a particular tagged snapshot of a repository on
# github.  This will no work for some repositories, like those with large
# binary files in them.
